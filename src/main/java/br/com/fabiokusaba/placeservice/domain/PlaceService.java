package br.com.fabiokusaba.placeservice.domain;

import br.com.fabiokusaba.placeservice.api.PlaceRequest;
import br.com.fabiokusaba.placeservice.util.QueryBuilder;
...
public class PlaceService {
    ...
    public Mono<Place> create(PlaceRequest placeRequest) {
        var place = new Place(null, placeRequest.name(), slg.slugify(placeRequest.name()), placeRequest.city(), placeRequest.state(), null, null);
